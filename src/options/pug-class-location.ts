...
export const PUG_CLASS_LOCATION: ChoiceSupportOption = {
	...
	choices: [
		{ value: 'before-attributes', description: 'Forces all valid class literals to be placed before attributes.' },
		{ value: 'after-attributes', description: 'Forces all valid class literals to be placed after attributes.' }
	]
};
